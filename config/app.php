...
return [
    ...
    // 站点配置
    'hostname'        => env('WEB_SITE_HOST', 'http://www.hlzblog.top'),
    ...
    'aliases'         => [
        ...
        // - 日志打印
        'LogService'    => App\Services\Tool\LogService::class,
        // - 异常处理
        'Consts'        => App\Exceptions\Consts::class,
        'ApiException'  => App\Exceptions\ApiException::class,
        // - 权限操作
        'CommonService' => App\Services\CommonService::class, // 用户登录后的模型
        // - 谷歌验证码
