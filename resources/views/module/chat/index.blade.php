                ...
                <div class="warp" title="智能客服">
                    <div class="list_content" id="yth-s_id_-1" yth-s_id="-1">
                        <div class="pic" title="头像">
                            <img src="/static/plugins/chat/img/head_pic/5.jpg" alt="头像">
                        </div>
                        <div class="info">
                    ...
                    <div class="list_content" id="yth-s_id_-2" yth-s_id="-2">
                        <div class="pic" title="头像">
                            <img src="/static/plugins/chat/img/head_pic/14.jpg" alt="头像">
                        </div>
                        <div class="info">
...
<div id="yth_chat_box" oncontextmenu="return false;">
    ...
    <div id="yth_chat_container">
        <div class="box">
            <div class="header">
                <div class="top_left">
                    <img src="/static/plugins/chat/img/head_pic/author.jpg" title="聊天对象" alt="聊天对象" id="dialog_with_whose_img">
                </div>
                <div class="top_right">
                    <div class="name">
...
<script type="yth/tpl" id="yth_chat_staff_list_tpl">
    {{# for(var i=0; i
    <d.length ;i++){ }} <div class="list_content " id="yth-s_id_{{d[i].s_id}}" yth-s_id="{{d[i].s_id}}">
        <div class="pic" title="头像">
            <img src="{{d[i].pic}}" alt="头像"></div>
        <div class="info">
            <div class="name" title="昵称" yth-descript="追求客户满意，是我们最大的责任">{{d[i].name}}</div>
            <div class="icons">
...
<script type="yth/tpl" id="yth_chat_logs_list_tpl">
    <div class="list_content" id="receive_s_id_{{d.s_id}}" yth-s_id="{{d.s_id}}">
        ...
        <div class="info">
            <div class="name" title="昵称" yth-descript="{{d.descript}}">{{d.name}}</div>
            <div class="icons">{{d.icons}}</div>
        </div>
    </div>
</script>
<script>
