	...
	<div class="container">
		<div class="discription">
	    	...
	    	<div class="appdownloadcode">
				<ul>
					<li>
						<img src="/static_pc/img/google/ios.png?v=1.2.1" width="280" height="280" /><br />Ios扫描下载
					</li>
					<li>
						<img src="/static_pc/img/google/android.png?v=1.2.1" width="280" height="280" /><br />安卓扫描下载
					</li>
				</ul>
			</div>
			<h5>步骤二：</h5>
		...
		<div class="container-form">
			...
			<form action="" method="POST">
				<input name="bind_secret" type="text" class="verificationcode" placeholder="请输入扫描后手机显示的6位验证码"  />
	        ...
	        <script src="{{ link_plugins('qrcode', 'qrcode.js')}}"></script>
        <script>
        var defaultContent = '{{ $createSecret["codeurl"] }}';
