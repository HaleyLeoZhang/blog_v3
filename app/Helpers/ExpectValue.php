...
// 一元线性回归，预期数据计算
// -------------------------------------------------------------
// 算法介绍：https://baike.baidu.com/item/一元线性回归方程/6953911
// -------------------------------------------------------------
...
class ExpectValue
{
    ...
    public static function compute(&$sample_arr)
    {
        ...
        $expect  = $ins->get_expect_y($const_a, $const_b, $sample_arr);
        return $expect;
    }
     ...
     * @return int
     */
    protected function get_expect_y($const_a, $const_b, $sample_arr)
    {
        $x      = count($sample_arr);
